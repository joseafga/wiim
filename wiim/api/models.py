...
class Record(db.Model):
    ...
    # tag = db.relationship('Tag', backref='records', lazy='dynamic')
...
class RecordSchema(ma.ModelSchema):
    ...
    # time_opc = fields.DateTime(required=True)
    # time_db = fields.DateTime(dump_only=True)
    # value = fields.String(required=True, validate=validate.Length(1))
    # quality = fields.String(required=True, validate=validate.Length(1))
